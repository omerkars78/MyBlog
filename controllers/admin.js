...
exports.get_contact_delete = async function(req, res){
    const blogid = req.params.blogid;
    ...
    try {
        const contact = await Contact.findOne({
            where: isAdmin ? {id: contactid} : {id: contactid, userId: userid }
        });

        if(contact) {
            return res.render("admin/contact-delete", {
...
exports.post_contact_delete = async function(req, res) {
    const contactid = req.body.contactid;
    try {
        const contact = await Contact.findByPk(contactid);
        if(contact) {
            await contact.destroy();
            return res.redirect("/admin/contacts?action=delete");
        }
        res.redirect("/admin/contacts");
    }
    catch(err) {
...
exports.get_contact_create = async function(req, res) {
    try {
...
exports.post_contact_create = async function(req, res) {
    ...
    try {
        ...
        res.redirect("/admin/contacts?action=create");
    }
    catch(err) {
        let hataMesaji = "";
...
exports.get_contact_edit = async function(req, res) {
    const contactid = req.params.contactid;
    ...
    try {
        const contact = await Contact.findOne({
            where: isAdmin ? {id : contactid} : { id: contactid }
            
        });
        
        if(contact) {
            return res.render("admin/contact-edit", {
...
exports.post_contact_edit = async function(req, res) {
    const contactid = req.body.contactid;
    const platform = req.body.platform;
    const platformLink = req.body.platformlink;
    let resim = req.body.resim;
    ...
    try {
        ...
        if(contact) {
            ...
            contact.platformLink = platformLink;
            contact.resim = resim;
            await contact.save();
...
exports.get_contacts = async function(req, res) {
    const contactid = req.session.contactid;


    try {
        const contacts = await Contact.findAll({ 
            attributes: ["id","platform","platformLink","resim"]
        });
